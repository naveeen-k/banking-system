...
public class Validator {
    ...
    public static String validateAccountType(String accountType) throws ValidationException {
    ...
    public static int validateInitialDeposit(int amount) throws ValidationException {
        if (amount < 500) {
    ...
    public static int validateAmount(String input) throws ValidationException {
        if (input == null || input.trim().isEmpty()) {
    ...
    public static void validateDifferentAccounts(String from, String to) throws ValidationException {
        if (from.equals(to)) {
