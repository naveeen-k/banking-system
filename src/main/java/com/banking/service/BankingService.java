...
public class BankingService {
    ...
    public Account createAccount(String name,String phone, String email,
        ...
        final Account account = new Account(accountNumber, name, phone, email, initialAmount, type);
    ...
    public String updateName(int accountNumber, String name) throws AccountNotFoundException {
        final Account account = getAccountOrThrow(accountNumber);
    ...
    public String transferMoney(int senderAccountNumber, int receiverAccountNumber, int amount)
            throws AccountNotFoundException, InsufficientFundsException {
        final Account sender = getAccountOrThrow(senderAccountNumber);

        final Account receiver = getAccountOrThrow(receiverAccountNumber);
